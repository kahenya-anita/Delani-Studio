"use strict";
function _classCallCheck(t: any, e: any):void {
...
var SimpleLightbox: () => any {
	...
	return _createClass(n, [{
		...
		value: function () {
			...
			this.addEventListener(window, "resize." + this.o, function (t) {
			...
			}, 40), this.addEventListener(this.p.d.getElementsByTagName("button"), "click." + this.o, function (t) {
				if (!t.currentTarget.tagName.match(/button/i)) return !0;
				t.preventDefault(), i.v.a = 0, i.loadImage(t.currentTarget.classList.contains("sl-next") ? 1 : -1)
				...
				if (!i.d) return i.v.s = t.clientX, i.v.t = t.clientY, i.v.j = i.getDimensions(i.p.h).height, i.v.k = i.getDimensions(i.p.h).width, i.v.n = i.getDimensions(i.n).height, i.v.o = i.getDimensions(i.n).width, i.v.l = i.p.h.offsetLeft, i.v.m = i.p.h.offsetTop, i.n.classList.add("sl-transition"), i.v.i ? (i.v.w = 1, i.setZoomData(i.v.w, 0, 0), i.zoomPanElement("0px", "0px", i.v.w), i.v.i = !1, "none" === i.p.g.style.display && i.fadeIn(i.p.g, 200)) : (i.v.w = i.options.doubleTapZoom, i.setZoomData(i.v.w, 0, 0), i.zoomPanElement("0px", "0px", i.v.w), i.p.g.style.opacity || "none" === i.p.g.style.display || i.fadeOut(i.p.g, 200), i.v.i = !0), setTimeout(function () {
					i.n && i.n.classList.remove("sl-transition")
				}, 200), !(i.v.p = !0)
			})
		}
				...
				for (var s, o = this.elements[Symbol.iterator](); !(e = (s = o.next()).done); e = !0) {
					...
					try {
						for (var v, d = t[Symbol.iterator](); !(r = (v = d.next()).done); r = !0) {
							var p = v.value;
							void 0 !== a.fullyNamespacedEvents && p in a.fullyNamespacedEvents && a.removeEventListener(p, a.fullyNamespacedEvents[p])
						}
					} catch (t) {
						l = !0, h = t
					} finally {
		...
		key: "destroy",
		value: function () {
			this.off(["close." + this.o, "closed." + this.o, "nextImageLoaded." + this.o, "prevImageLoaded." + this.o, "change." + this.o, "nextDone." + this.o, "prevDone." + this.o, "error." + this.o, "changed." + this.o, "next." + this.o, "prev." + this.o, "show." + this.o, "shown." + this.o]), this.removeEventListener(this.elements, "click." + this.o), this.removeEventListener(document.body, "contextmenu." + this.o), this.removeEventListener(document.body, "keyup." + this.o), this.removeEventListener(this.p.d.getElementsByTagName("button"), "click." + this.o), this.removeEventListener(this.p.b, "click." + this.o), this.removeEventListener(window, "resize." + this.o), this.removeEventListener(window, "hashchange." + this.o), this.close(), this.g && (document.body.removeChild(this.p.a), document.body.removeChild(this.p.f)), this.elements = null
		}
	}, {
		key: "refresh",
		value: function () {
